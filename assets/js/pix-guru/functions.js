    ...
    function init_popup(){
        if($(window).width() + boutique_get_scrollbar_width() >= 768){
            if($('body').hasClass('home')){
                ...
                $.magnificPopup.open({
                  items: {
                    src: '<div class="white-popup"><div class="kt-popup-newsletter"><div class="popup-title"><h3>Pix-Guru</h3><p class="notice">Become a memeber and <br> <span class="primary">Never miss out</span><br><br> Stay on top of the buzz of an ever-changing photography world with our assistance</p><br></div><button class="button">NO THANKS!</button><button class="button">YES PLEASE</button></div></div>',  //can be a HTML string, jQuery object, or CSS selector
                    type: 'inline'
                  }
                });
            }
